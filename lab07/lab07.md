...
1. Какой IP-адрес и номер порта TCP использует ваш компьютер (отправитель), передающий
   ...
   - IP-адрес: 172.24.31.5; Source Port: 61821
...
4. Какой порядковый номер у SYNACK-сегмента, отправленного сервером gaia.cs.umass.edu
   ...
   - следующий номер, который отправитель сегмента ожидает получить
...
6. Рассмотрите TCP-сегмент, содержащий команду POST протокола HTTP, как первый TCP-сегмент 
   ...
   - Sequence Number: 1, Sequence Number (raw): 1590025248
   Sequence Number: 635, Sequence Number (raw): 1590025882
   Sequence Number: 1983, Sequence Number (raw): 1590027230
   Sequence Number: 3331, Sequence Number (raw): 1590028578
   Sequence Number: 4679, Sequence Number (raw): 1590029926
   Sequence Number: 6027, Sequence Number (raw): 1590031274
   Sequence Number: 7375, Sequence Number (raw): 1590032622
   - 4.125954;
   4.126137;
   4.126140;
   4.126142;
   ...
   - 4.295875; у остальных нет
   - 0.169921; остальные нельзя посчитать
7. Чему равна пропускная способность (количество байтов, передаваемых в единицу
   ...
   - 777 Kб/с
   - winsize = 132096 б, rtt = 0.169921, winsize/rtt = 777 Kб/с
